...
function createtime1() {
  var grt = new Date("06/19/2025 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Fomalhaut🥝 %c 你正在访问ChenYuJie🥝の小家",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("06/19/2025 00:00:00");
  ...
  let currentTimeHtml = "";
  (currentTimeHtml =
    `<img class='boardsign' src='../F小屋-下班休息啦.svg' title='记录时光的流逝'><br>
     <div style="font-size:13px;font-weight:bold">本站运行 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://w.wallhaven.cc/full/5g/wallhaven-5g22q5.png);
    --darkmode-bg:url(https://w.wallhaven.cc/full/d8/wallhaven-d85ewm.png);
    --mobileday-bg: url(https://w.wallhaven.cc/full/d8/wallhaven-d85ewm.png);
    --mobilenight-bg: url(https://w.wallhaven.cc/full/d8/wallhaven-d85ewm.png);
  }`;
}
// 切换背景主函数
function changeBg(s) {
